...
public class Fast2DArray<T> : IEnumerable<T>
{
    ...
    /// Returns the element at the specified position of the array.
    /// </summary>
    public T Get(Vector2Int position) => array[position.x * XSize + position.y];
    ...
    /// Sets the element at the specified position of the array.
    /// </summary>
    public void Set(T element, Vector2Int position) => array[position.x * XSize + position.y] = element;
    ...
    /// Util method to check if given ints are in the bounds of the array.
    /// </summary>
    public bool InBounds(Vector2Int position) => position.x > -1 && position.x < XSize && position.y > -1 && position.y < YSize;
